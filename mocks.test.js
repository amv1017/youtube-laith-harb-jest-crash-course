...
it("mock callback", () => {
	...
	forEach([72, 81], mockCalledback)
	expect(mockCalledback.mock.calls.length).toBe(2)
	expect(mockCalledback.mock.calls[0][0]).toBe(72)
	expect(mockCalledback.mock.calls[1][0]).toBe(81)
	expect(mockCalledback.mock.results[0].value).toBe(114)
	expect(mockCalledback.mock.results[1].value).toBe(123)
})
